...
<template>
  <article class="produto-card" @click="irParaDetalhes">
    <div class="produto-imagem">
      ...
      <div v-if="produto.avaliacao" class="avaliacao">
...
.produto-card {
  ...
  overflow: hidden;
  background: #ffffff;
  border: 1px solid rgba(94, 48, 35, 0.07);
  border-radius: 24px;
  box-shadow:
    0 5px 15px rgba(94, 48, 35, 0.05),
    0 15px 35px rgba(94, 48, 35, 0.07);
  cursor: pointer;
  transition:
    transform 0.3s ease,
...
.produto-card:hover {
  ...
  border-color: rgba(184, 151, 100, 0.28);
  box-shadow:
    0 10px 20px rgba(94, 48, 35, 0.08),
    0 22px 45px rgba(94, 48, 35, 0.12);
}
...
.produto-card:hover .ver-produto {
  opacity: 1;
...
.produto-rodape {
  ...
  gap: 10px;
  padding-top: 12px;
  border-top: 1px solid rgba(184, 151, 100, 0.2);
}
...
.botao-detalhes {
  ...
  font-size: 0.8rem;
  cursor: pointer;
  box-shadow: 0 6px 14px rgba(94, 48, 35, 0.16);
  transition:
